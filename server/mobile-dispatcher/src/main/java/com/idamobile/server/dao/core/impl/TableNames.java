...
public class TableNames {
	...
	private static final String UBRR_VIEWS_SUFFIX = "";//@vpdb";
	
	public static final String NEWS 			= "ida_news" + UBRR_VIEWS_SUFFIX;
	public static final String CURRENCY_RATES 	= "ida_currency_rates" + UBRR_VIEWS_SUFFIX;
